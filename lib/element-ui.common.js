	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    directives: [{
	      name: "show",
	      rawName: "v-show",
	      value: (!_vm.disabled && _vm.showPopper && _vm.contentProxy.length > 0),
	      expression: "!disabled && showPopper && contentProxy.length > 0"
	    }],
	    ref: "popper",
	    ...
	    domProps: {
	      "textContent": _vm._s(_vm.contentProxy)
	    }
	  })])], 2)])], 1)
	},staticRenderFns: []}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.install = function (Vue) {
	  ...
	  var toggleLoading = function toggleLoading(el, binding) {
	    if (_typeof(binding.value) === 'object' && binding.value.value || _typeof(binding.value) !== 'object' && binding.value) {
